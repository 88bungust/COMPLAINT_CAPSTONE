...
complaints = complaints[complaints["Date received"].notna()]

complaints2 = pd.read_csv("Copy of Complaints csv.csv")


complaints['Complaint ID'] = complaints['Complaint ID'].astype(int).astype(str)
complaints2['Complaint ID'] = complaints2['Complaint ID'].astype(int).astype(str)
